...
def get_initial_conditions(M, rho0, rho_dot0):
    ...
    x0_bary = 9.2294247990951594E-1 # nd 
    y0_bary = 3.5423160021690485E-29 # nd 
    ...
    vy0_bary = 1.2786666755130519E-1 # nd 
    ...
    # # print(initial_conditions_M,initial_conditions_chaser_LVLH)
    ...
    # file.close()
    return initial_conditions_chaser_LVLH[:6], initial_conditions_chaser_LVLH[6:12], initial_conditions_chaser_M